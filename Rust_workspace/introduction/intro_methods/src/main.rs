...
impl Point {
    ...
    // Static methods don't need to be called by instance.
    // These methods are generally used as constructors.
    fn origin() -> Point {
        Point { x: 0.0, y: 0.0}
    }

    // Another static methods, taking two arguments.
...
impl Rectangle {
    ...
    fn area(&self) -> f64 {
        ...
        // 'abs' is a 'f64' method that return the absolute value of the caller.
        ((x1 - x2) * (y1 - y2)).abs()
    }
...
impl Pair {
    ...
    fn destroy(self) {
        ...
        println!("Destructure Pair({}, {})", first, second)
    }
}
...
fn main() {
    ...
    // 'rectangle.parameter()' == 'Rectangle::parameter(&rectangle)'
